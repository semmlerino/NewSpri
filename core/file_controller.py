...
class FileController(QObject):
    ...
    def _on_recent_file_selected(self, file_path: str):
        ...
        Note: File existence is already validated by RecentFilesManager
        before this callback is invoked, so no existence check needed here.
        """
        self.load_file(file_path)

    # Core file operations
    def open_file_dialog(self, parent=None) -> str | None:
        """
    ...
    def extract_file_from_drop(self, drop_event: QDropEvent) -> str | None:
        """
