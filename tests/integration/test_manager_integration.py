...
from managers import (
    get_actionmanager, get_menu_manager, get_shortcut_manager,
...
class TestManagerIntegration:
    ...
    def test_all_managers_can_initialize(self):
        """Verify all manager singletons can be initialized without conflicts."""
        # Get all managers
        action_manager = get_actionmanager()
        ...
        assert get_actionmanager() is action_manager
        assert get_menu_manager() is menu_manager
    
    def test_manager_initialization_order_independence(self):
        """Test that managers can be initialized in any order."""
        # Clear any existing singletons (if possible)
        # Note: This might require modifying manager implementations
...
class ManagerTestHelper:
    ...
    @staticmethod
    def reset_all_managers():
        """Reset all manager singletons for testing."""
        # This would require manager implementations to support reset
