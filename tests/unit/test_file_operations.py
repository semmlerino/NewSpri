...
class TestFileValidator:
    ...
    def test_validate_case_insensitive_extensions(self, temp_dir):
        ...
        test_files = ["test.PNG", "test.Png", "test.JPG", "test.jpeg", "test.JPEG"]
...
class TestFileOperationsIntegration:
    ...
    def test_error_propagation_through_workflow(self):
        ...
        success, pixmap, metadata, error = loader.load_sprite_sheet(
