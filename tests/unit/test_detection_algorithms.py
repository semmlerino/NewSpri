...
class TestFrameDetector:
    ...
    @pytest.mark.parametrize(
        "width,height,min_expected_size",
        [
...
class TestAutoDetectionController:
    ...
    def test_run_frame_detection_success(self, qapp):
        ...
        mock_sprite_model.auto_detect_rectangular_frames.return_value = (
            True,
            32,
            32,
            "Test success",
    ...
    def test_run_spacing_detection_success(self, qapp):
        ...
        mock_sprite_model = Mock()
        mock_sprite_model.original_sprite_sheet = QPixmap(100, 100)
        mock_sprite_model.auto_detect_spacing_enhanced.return_value = (
            True,
            2,
            2,
            "Test spacing (high confidence)",
        )
...
@pytest.mark.parametrize(
    "sheet_size,frame_size,expected_frames",
    [
...
class TestDetectionIntegration:
    ...
    def test_full_detection_workflow(self, qapp):
        ...
        margin_success, offset_x, offset_y, _ = detect_margins(pixmap, frame_width, frame_height)
        assert margin_success
