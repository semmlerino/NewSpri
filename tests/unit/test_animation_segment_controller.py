...
class TestAnimationSegmentController(unittest.TestCase):
    ...
    def test_create_segment_name_conflict_resolution(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".png") as tmp:
            ...
            existing_segment = AnimationSegment(name="TestSegment", start_frame=10, end_frame=19)
            ...
            new_segment = AnimationSegment(name="TestSegment", start_frame=0, end_frame=9)
    ...
    def test_create_segment_max_retry_failure(self):
        ...
        mock_segment_manager.add_segment.return_value = (
            False,
            "Segment 'TestSegment' already exists",
        )
        ...
        self.assertEqual(
            mock_segment_manager.add_segment.call_count, self.controller.MAX_NAME_RETRY_ATTEMPTS + 1
        )
