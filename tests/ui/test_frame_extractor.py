...
class TestFrameExtractorInitialization:
    ...
    def test_default_state(self, qapp):
        ...
        assert widget.get_extraction_mode() == ExtractionMode.CCL
...
@pytest.mark.parametrize(
    "width,height",
    [(32, 32), (48, 48), (64, 64), (128, 128), (192, 192), (32, 48), (48, 32), (64, 48), (48, 64)],
)
...
@pytest.mark.parametrize("mode", [ExtractionMode.GRID, ExtractionMode.CCL])
