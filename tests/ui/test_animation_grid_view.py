...
class TestFrameThumbnail:
    ...
    def test_real_click_behavior_with_modifiers(
        self, qtbot, real_event_helpers, real_signal_tester
    ):
        ...
        ctrl_event = real_event_helpers.create_mouse_press(
            16, 16, Qt.LeftButton, Qt.ControlModifier
        )
...
class TestRealImageIntegration:
    ...
    def test_grid_with_real_sprite_frames(self, qtbot, real_image_factory):
        ...
        real_frames = real_image_factory.create_animation_frames(
            count=8, size=(48, 48), animation_type="rotate"
        )
    ...
    def test_segment_creation_with_real_sprite_sheet(
        self, qtbot, real_image_factory, real_signal_tester
    ):
        ...
        sprite_sheet = real_image_factory.create_sprite_sheet(
            frame_count=6, frame_size=(32, 32), layout="horizontal", spacing=2, margin=1
        )
