...
class AnimationSegmentSelector(QGroupBox):
    ...
    def __init__(self, segment_manager: Optional[AnimationSegmentManager] = None):
...
def create_segment_selector(segment_manager: Optional[AnimationSegmentManager] = None) -> AnimationSegmentSelector:
