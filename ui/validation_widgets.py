...
class ValidatedLineEdit(QLineEdit):
    ...
    def __init__(self, validator_func: Callable[[str], tuple[str, str]] | None = None, parent=None):
...
class SmartDirectorySelector(QWidget):
    ...
    def create_directory_if_needed(self) -> tuple[bool, str]:
        ...
        try:
            ...
            return False, f"Failed to create directory: {e!s}"
...
class PatternEdit(ValidatedLineEdit):
    ...
    def _validate_pattern(self, pattern: str) -> tuple[str, str]:
        ...
        try:
            ...
            return ValidationState.ERROR, f"Invalid pattern: {e!s}"
