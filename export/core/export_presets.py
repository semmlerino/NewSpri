...
class ExportPresetManager:
    ...
    BUILTIN_PRESETS = {
        ...
        ExportPresetType.SEGMENTS_PER_ROW: ExportPreset(
            ...
            use_cases=["Game engines", "Animation tools", "Organized sprite sheets", "State-based animations"],
            estimated_size_multiplier=0.85,
            sprite_sheet_layout=SpriteSheetLayout(
            ...
            recommended_for=["Game development", "State machines", "Clean organization"]
        )
    }
    ...
    def get_presets_by_type(self, preset_type: ExportPresetType) -> List[ExportPreset]:
        ...
        if preset_type == ExportPresetType.STANDARD:
            # Return the main presets for the wizard
            return [
                ...
                self.BUILTIN_PRESETS.get(ExportPresetType.SEGMENTS_PER_ROW)
            ]
