...
class ShortcutDefinition:
    ...
    callback: Optional[Callable] = None  # Function to call (set during registration)
    action: Optional[QAction] = None     # Associated QAction (if any)
...
class ShortcutManager(QObject):
    ...
    def get_shortcut_definition(self, shortcut_id: str) -> Optional[ShortcutDefinition]:
        """
...
_shortcut_manager_instance: Optional[ShortcutManager] = None
...
def get_shortcut_manager(parent: QWidget = None) -> ShortcutManager:
    ...
    Args:
        parent: Parent widget (only used for first initialization)
