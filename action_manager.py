...
from shortcut_manager import get_shortcut_manager, ShortcutContext
...
_action_manager_instance: Optional[ActionManager] = None


def get_action_manager(parent: QWidget = None) -> ActionManager:
    """
