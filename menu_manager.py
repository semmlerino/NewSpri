...
from action_manager import get_action_manager, ActionManager
...
class MenuManager(QObject):
    ...
    def __init__(self, parent: QMainWindow = None):
        ...
        self._action_manager = get_action_manager(parent)
...
def get_menu_manager(parent: QMainWindow = None) -> MenuManager:
    ...
    Args:
        parent: Parent main window (only used for first initialization)
        
    Returns:
        Global MenuManager instance
    """
