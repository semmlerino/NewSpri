...
class MenuManager(QObject):
    ...
    def _create_menu(self, menu_id: str, parent) -> QMenu | None:
        """
    ...
    def create_toolbar(self, toolbar_id: str) -> QToolBar | None:
        """
    ...
    def get_toolbar(self, toolbar_id: str) -> QToolBar | None:
        """
    ...
    def get_menu_definition(self, menu_id: str) -> MenuDefinition | None:
        """
    ...
    def get_toolbar_definition(self, toolbar_id: str) -> ToolbarDefinition | None:
        """
