...
class DetectionCoordinator:
    ...
    def comprehensive_auto_detect(self, sprite_sheet: QPixmap, sprite_sheet_path: Optional[str] = None) -> Tuple[bool, str, DetectionResult]:
        """
                    ...
                    try:
                        ...
                        if rect_success:
                            ...
                            try:
                                ...
                                results.append(f"   ✗ Basic detection error: {str(e)}")
                                overall_success = False
                                confidence_scores.append(0.1)
                    except Exception as e:
...
def comprehensive_auto_detect(sprite_sheet: QPixmap, sprite_sheet_path: Optional[str] = None) -> Tuple[bool, str, DetectionResult]:
    """
